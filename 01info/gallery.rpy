...
screen gallery():
    ...
    vbox:
        ...
        imagebutton auto"gui/button/Reina_%s.png" action Show("gallery_a")
        imagebutton auto"gui/button/Jenni_%s.png" action Show("gallery_b")
        imagebutton auto"gui/button/Camilla_%s.png" action Show("gallery_c")
        imagebutton auto"gui/button/Briana_%s.png" action Show("gallery_d")
        imagebutton auto"gui/button/Penny_%s.png" action Show ("gallery_e")
        imagebutton auto"gui/button/Rose_%s.png" action Show("gallery_f")
        imagebutton auto"gui/button/Aisha_%s.png" action Show ("gallery_g")
        imagebutton auto"gui/button/Sabrina_%s.png" action Show ("gallery_h")
        imagebutton auto"gui/button/Miyuki_%s.png" action Show("gallery_i")
        imagebutton auto"gui/button/Videos_%s.png" action Show ("gallery_j")
...
#Reina Videos
    showif cg_page_j == 1:
        grid 4 4:
            style_prefix "gallery_stuff"
            add g.make_button("cg_reinavideo01","images/thumbnails/reinafullvid01.webp")
            add g.make_button("cg_reinavideo02","images/thumbnails/reinafullvid02.webp")
            add g.make_button("cg_reinavideo03","images/thumbnails/reinafullvid03.webp")
            
            add g.make_button("cg_jennivideo01","images/thumbnails/jennifullvid01.webp")
            add g.make_button("cg_jennivideo02","images/thumbnails/jennifullvid02.webp")
            add g.make_button("cg_jennivideo03","images/thumbnails/jennifullvid03.webp")
            ...
            add g.make_button("cg_sabrinavideo01","images/thumbnails/sabrinafullvid.webp")
            add g.make_button("cg_brianavideo01","images/thumbnails/brianafullvid.webp")
            add g.make_button("cg_miyukivideo01","images/thumbnails/miyukifullvid.webp")
