        ...
        hbox:
            ...
            frame:
                ...
                vbox:
                    ...
                    text _("You have {color=#f00}[selectedChapter.status]{/color} this event.") size 30
        ...
        hbox:
            ...
            frame:
                ...
                vbox:
                    xoffset 50
                    yoffset 0
                    text _("Chapter 2: Recovery")  style "storyline_label"

                vbox:
                    xoffset 50
                    yoffset 80
                    textbutton _("[prologue02.name]") hovered SetVariable("selectedChapter", prologue02) action [Hide("storymode_screen"),Jump("prologue02")]
        ...
        hbox:
            ...
            frame:
                ...
                vbox:
                    xoffset 50
                    yoffset 20
                    text _("Chapter 3: Changes")  style "storyline_label"
                vbox:
                    xoffset 50
                    yoffset 80
        ...
        hbox:
            ...
            frame:
                ...
                vbox:
                    xoffset 50
                    yoffset 20
                    text _( "Chapter 4: Consequences") style "storyline_label"
                vbox:
                    xoffset 50
                    yoffset 80
        ...
        hbox:
            ...
            frame:
                ...
                vbox:
                    xoffset 50
                    yoffset 20
                    text _("Chapter 5:A New Man") style "storyline_label"
                vbox:
                    xoffset 50
                    yoffset 80
        ...
        hbox:
            ...
            frame:
                ...
                vbox:
                    xoffset 50
                    yoffset 20
                    text _("Epilogue") style "storyline_label"
                vbox:
                    xoffset 50
                    yoffset 80
