...
label reinaevent01:
    ...
    reina "I wanted you to move in our house, but my younger sister Jenni is currently staying with us."
    reina "She's staying in the bedroom I prepared for you, so you're housesitting a cottage I just bought."
    ...
    reina "It's Marlot."
    menu:
        "I didn't know you liked wine. (+1 Reina Love)":
            scene 11reina01
            $ReinaC.love_up(1)
            reina "I've always liked wine. I just never had a chance to really enjoy it until a few years ago."
            ...
            scene 12reina01
            reina "Well, it's coming with me. "
            main "I can handle myself."
            scene 13reina01
            reina "No. You're not allowed anything, ok? No drugs, no alcohol. Nothing. "
            reina "Those were Ethan's terms."
            reina "Thankfully, there's only one bottle in here."

        "What do you like, Reina?(+1 Reina Trust)":
            scene 11reina01
            $ReinaC.trust_up(1)
            ...
            main "Reina, I have never had a problem with alcohol, I'm fine."
            scene 13reina01
            reina "Do you understand the situation that you're in, [player_name]?"
            reina "Ethan wanted you to rot on the street. But I begged him to give you another chance."
    ...
    scene 15reina01
    reina "The refrigator's empty, well that's a good thing. No one wants someone else's food."
    reina "There's a grocery store a few blocks from here."
    scene 16reina01
    reina "Let's see if the water is still running."
    scene 17reina01
    reina "It is!"
    ...
    reina "If you listen closely, you can hear the ocean from here. It's perfect."
    stop sound
    scene 21reina01
    ...
    menu:
        "Will I have to pay rent?":
            reina "No [player_name], I would never force you to pay rent. "
            ...
            scene 29reina01
            reina "I'm just glad to have you here, with us."
            scene 31reina01
            reina "And I'm sorry for letting my husband kick you out years ago."
            reina "I promise it won't happen again."
        "Thanks, Reina.":
            scene 29reina01
            reina " You're welcome, [player_name]. I'm so relieved that you're safe and sound.  "
            scene 30reina01
            reina "And...I'm sorry. I'm sorry I didn't reach out to you earlier. "
