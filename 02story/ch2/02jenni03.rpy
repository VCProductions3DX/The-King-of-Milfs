label jennievent03:
    ...
    menu:
        "Do you like cooking, Jenni?":
            ...
            scene 23jenni03
            jenni "Here you go."
        "Are you the homemaker of the family, Jenni?":
            jenni "Actually, that was Reina."
    ...
    if jennievent03.status == "completed":
        ...
        menu:
            "Tell Jenni the entire story.(Jenni Trust + 3)":
    ...
    main "And what about Ethan?"
    jenni "Ethan hasn't come home since the incident. It's better that way."
    main "Briana and Penny?"
    scene 34jenni03
    jenni "The girls keep to themselves. They grab whatever I'm cooking, then disappear into their rooms."
    ...
    scene 42jenni03
    jenni "Is it so strange to have someone care for you?"
    jenni "I know you're not related to us in any shape or form, but you're family."
    jenni "And we take care of each other. Any and every way we can."
    scene 43jenni03
    jenni "Besides, I like you. You remind me of myself."
    main "How?"
    scene 44jenni03
    ...
    menu:
        "Accept (Jenni Love + 5 )": 
            ...
            jenni "My hands up and down your long, hard cock."
            jenni "Let yourself go."
            menu:
                "Cum on Jenni's hands.": 
                    jenni "Easy does it."
                    jenni "You made quite a mess."
                    scene hj02jenni03
                    main "Fuck. I'm sorry, Jenni."
                    jenni "Why are you sorry?"
                    main "I-"
                    scene hj03jenni03
                    jenni "Like I said before, we're family. We take care of each other."
                    jenni "No one has to know."
                    main "Thanks."
                    scene 48jenni03 with fade
                    jenni "I think it's time for you to go to bed."
                    main "Jenni-"
                    jenni "I'll sleep out here. Come now-"
                ...
                "I can't.": 
                    ...
                    jenni "I think it's time for you to go to bed."
                    main "Jenni-"
                    jenni "I'll sleep out here. Do you need any help getting up?"
                    main "I can get up on my own."
                    jenni "Good night, [player_name]. Sleep tight."  
                    jump aishaevent01
        "Refuse.": 
