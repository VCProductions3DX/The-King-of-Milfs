label prologue03:
    ...
    newsreporter "Breaking news, a body has washed up in the Sierra River Basin."
    newsreporter "Authorities have identified the body as a young female. An autopsy is being performed on her cause of death."
    newsreporter "We will update you once we have more information."
    "(A body?)"
    "(Could it be her?)"
    scene 04prologue03
