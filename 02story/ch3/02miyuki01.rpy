label miyukievent01:
    ...
    scene 14miyuki01
    "(It's a picture of her...and Ethan!)"
    "(So she really is dating Ethan.)"
    menu:
        "Take a picture for Reina.":
            with flash
            "(I have to let Reina know.)"
            scene 15miyuki01
            $choices.append(miyukiethanphoto)
            "(I'll give it to her when I see her next time.)"
            jump afterpicture
        "Do nothing.":
            "(It's not my place to get in between Reina and Ethan.)"
...
label afterpicture:
    ...
    "(She has no idea that I know Ethan.)"
...
label miyukifuck:
    ...
    scene 44miyuki01
    "(Not only did I discover Ethan's girlfriend.)"
    "(But I'm going to fuck her.)"
    scene 45miyuki01
    ...
    "(Quality is terrible but it shows what's important.)"
    scene 50miyuki01
...
label mcleavesmiyukisoffice:
    scene 54miyuki01
    "(That was awkward.)"
    "(One thing I know for certain- Ethan is cheating on Reina with her.)"
