label reinaevent05:
    ...
    scene 02reina05
    "[player_name]?"
    scene 05reina05 with Pause(2)
    scene 06reina05 with Pause(2)
    scene 08reina05
    "(She looks completely different.)"
    scene 10reina05
    reina " Hello [player_name]."
    reina "You're looking handsome tonight."
    main "You look lovely, Reina."
    ...
    scene 16reina05
    reina "I haven't seen you in over a month. You look a lot healthier."
    ...
    if reinaevent05.status == "completed":
        ...
        scene 17reina05
        reina "Do you mind helping Jenni move to her new apartment tomorrow?"
        ...
        menu:
            ...
            "Talk about Penny. (Penny Love + 3)":
                main "Meeting Penny at the skatepark."
                $PennyC.love_up(3)
                scene 15reina05
                reina "You too? It seems like she lives there."
                reina "Is she teaching you how to skate as well?"
                main "No- I'm recording her skating sessions and uploading it online."
                scene 16reina05
                reina "Really? Can I see them?"
                main "Penny is a bit shy about anyone in the family seeing them."
                reina "Why not?  It's just her skating, right?"
                main "It is."
                scene 17reina05
            ...
            "Talk about Jenni. (Jenni Love + 3)":
                $JenniC.love_up(3)
                main "Jenni stops by the cottage to check on me."
    ...
    reina "My daughters will leave, Jenni will move out..it will just be me."
