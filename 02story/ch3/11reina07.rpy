...
label mcfollowsreina:
    ...
    show 36reina07 with Pause(2)
    scene 33reina07
    reina "[player_name]."
    reina "So that's how you feel about me."
    show 34reina07 with Pause(2)
    ...
    scene 46reina07
    "(She shoved her tits in my face.)"
    scene 45reina07
    reina "Go on, suck my tits."
    scene 44reina07
    reina "Your tongue feels so good."
    scene 50reina07
    reina "I want you to please me, [player_name]."
    show 49reina07 with Pause(2)
    scene 48reina07
    ...
    label middleofthenightfuck:
        ...
        menu:
            "(Fuck her again.)":
                ...
                "(I want to fuck her all of the time.)"
                main "Fuck!"
                reina "I love you."
