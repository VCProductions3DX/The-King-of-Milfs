label jennievent06:
    ...
    if jennievent05.status=="completed":
        ...
        jenni "(Did they?)"
        scene 03jenni06
        jenni "(No, no Reina isn't the kind of woman to have sex so soon.)"
        jenni "(She's too stuck-up for that.)"
        scene 04jenni06
        jenni "(But even if she was, she wouldn't screw someone she sees as her own soon.)"
        scene 05jenni06
...
label mcwakesuponcouch:
    ...
    main "Reina offered me your room."
    scene 11jenni06
    jenni "Did she?"
    ...
    scene 18jenni06
    jenni "I know I can be a bit annoying, but I've taken a liking to you, [player_name]."
    scene 19jenni06
    jenni "I don't want you to become addicted again and worry Reina."
    scene 20jenni06
    ...
    scene 22jenni06
    jenni "You know you can always stay with me if you don't like it with Reina."
    ...
    if reinashowerfuck in choices:
        "(I just fucked Reina..now Jenni wants me too.)"
        menu:
            "Ask for a blowjob.":
                jump jenniblowjob2
            "Ask for a titjob.":
...
label jenniblowjob2:
    ...
    show text "I hope you like me sucking your cock as much as I do." at thoughtsright with Pause(15)
    scene jennicottagebj2
