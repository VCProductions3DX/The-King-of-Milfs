label camillaevent05:
            ...
            "Do I get to go for free?":
                ...
                menu:
                    "Count me in.":
                        ...
                        scene 18camilla05
                        camilla "In fact, I want some right now." ## Change this
                        main "Now?"
                        scene 19camilla05
                        camilla "Now."
                    ...
                    "It's not possible right now.":
                        ...
                        camilla "For old times' sake? " #edit
                        menu:
                            "Sure.":
                                jump camillasecondfuck
                            "No thanks.":
    ...
    label camillapoliticstalk:
        ...
        if miyukiblackmail is in choices:
    ...
    label camillasecondfuck:
        ...
        scene camillablowjob
        camilla "Scoot back, dear."
        camilla "There we go."
        camilla "How do you like that?"
        camilla "Don't be shy, I can handle everything you've got."
        camilla "Yeah, that's it."
        camilla "Good boy."
        camilla "We'll keep in touch, right?"
        main "Right."
        camilla "See you later."
        jump ch4freeroam