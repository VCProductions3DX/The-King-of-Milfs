label ruinedending:
    ...
    ethan "Just look at the lives you've destroyed!"
    ethan "When no one else wanted to take you in, they did!"
    ethan "And you sell them like cattle!"
    ...
    menu:
        "(Reina.)":
            if ReinaC.c_love >=8:
                ...
                reina "You never bothered to raise him. I did. For Anna."
                scene 11ruinedending
                reina "For all of his faults, [player_name] is good man."
                scene 12ruinedending
                reina "And in Anna's memory, I will do everything to protect him."
                scene 13ruinedending
                reina "I will take care of [player_name]. For his own mother's sake."
                ...
                scene 08ruinedending
                main "Reina"
                ethan "Her generosity has run out."
                scene 06ruinedending
                ethan "As should you."
                ethan "Leave."
                jump outonthestreet
        "(Aunt Jenni.)":
            if JenniC.c_love >8:
                ...
                jenni "I'm a better judgment of character than you are. He won't."
