...
label pickcommitment:
    menu:
        ...
        "(Go hiking with Briana.)" if brianarelationship in choices:
            jump brianaending
        "(Help Penny record an album.)" if pennyrecord in choices:
            jump pennyending
        "(Move with Jenni.)" if jennimove in choices:
            jump jenniending
        "(Help Reina.)" if reinarelationship in choices:
            jump reinaending
