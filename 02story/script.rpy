...
define reina = Character("Reina",image= "reina")
define briana = Character ("Briana", image="briana")
define penny = Character ("Penny", image="penny")
define jenni = Character ("Jenni", image="jenni")
define ethan = Character ("Ethan", image="ethan")
...
default ReinaC = CharacterData("Reina", "Real Estate Agent","A well-known real estate agent who sells luxury homes to the wealthy, Reina often neglects her own family for riches.","Wine", c_trust=0, m_trust=10,c_love=0, m_love=10 ,a_pic="gui/characters/Reina_a.webp",u_pic ="gui/characters/Reina_u.webp",pic="gui/characters/Reina_Profile.webp")
default JenniC = CharacterData("Jenni", "Reina's Sister","A former model, Jenni is recovering from her first divorce." ,"Sweets", c_trust=0, m_trust=10,c_love=0, m_love=10 ,a_pic="gui/characters/Jenni_a.webp",u_pic ="gui/characters/Jenni_u.webp",pic="gui/characters/Jenni_profile.webp")
...
default AishaC = CharacterData("Aisha", "Police Detective","Aisha is the police detective assigned to a missing person's case who believes she'll find the answers in Sierra Beach." ,"Animals",c_trust=0, m_trust=10,c_love=0, m_love=10 ,a_pic="gui/characters/Aisha_a.webp",u_pic ="gui/characters/Aisha_u.webp",pic="gui/characters/Aisha_Profile.webp")
default SabrinaC = CharacterData("Sabrina", "Owner of Sierra Beach Games and Fun","Sabrina's family moved to Sierra Beach 5 years ago,opening the town's first and only game store. With her parents vacationing overseas, Sabrina runs the store by herself." ,"Video Games",c_trust=0, m_trust=10,c_love=0, m_love=10, a_pic="gui/characters/Sabrina_a.webp",u_pic ="gui/characters/Sabrina_u.webp",pic="gui/characters/Sabrina_Profile.webp")
