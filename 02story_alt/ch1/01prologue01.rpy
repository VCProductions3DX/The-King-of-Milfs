label prologue:
    ...
    scene 14prologue01
    reina "Yes, I am his mother."
    scene 15prologue01
    reina "But I haven't seen him in seven years."
    scene 16prologue01
...
label visittherapist:
    ...
    scene 34prologue01
    rose "Oldest of three, normal upbringing."
    rose "You ran away from home when you were 18."
    ...
    scene 37prologue01
    rose "Don't say that."
    rose "Even if you don't consider them your family, they are your flesh and blood."
...
label leaverehab:
    ...
    "(No choice but to call Mom, I guess.)"
    scene 46prologue01
