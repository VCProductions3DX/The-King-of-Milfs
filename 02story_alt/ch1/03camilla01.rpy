label camillaevent01:
    ...
    scene 03camilla01
    "Just you, right?"
    main "For now. I'm just house-sitting for my mom until I can find my own place."
    scene 04camilla01
    "And the first thing you do is christen it."
    "I don't think your mother would be too pleased with that."
    "It's one of the oldest cottages in town."
    main "I'm sorry, I thought no one was looking."
    scene 05camilla01
    ...
    "(Fuck.)"
    scene 19camilla01
    "(There's nothing else to do until Mom returns tomorrow.)"
    ...
    "(I only stayed because of Mom.)"
    scene 24camilla01
    "(Mom...)"
    menu:
        "(Fuck, I'm hard again.)":
            scene reinamasturbation with fadewhite
            reina "Hmmm, [player_name], come taste your mommy's pussy."
            reina "Mommy misses her baby boy."
            scene 20camilla01
            "(What the fuck is wrong is me?)"
            "(I'm going crazy over my own mom.)"
            "(Shit, I need to get laid or something.)"
            "(Maybe I'll visit Sabrina after all.)"
            jump reinaevent02
