label brianaevent02:
    ...
    if brianaevent01.status == "skipped":
        ...
        scene 04briana02
        briana "Do you remember your younger sister now?"
        main "Yeah-I-I'm sorry."
        scene 05briana02
        briana "I missed you, [player_name]."
        briana "I didn't realize how much I've missed you until dad started managing me."
        main "Dad's your manager?"
        scene 06briana02
        briana "Yeah. He is."
...
label brianadrivesmchome:
    ...
    scene 28briana02
    ethan "You're NOT retiring. You're GOING to compete in the Olympics!"
    scene 29briana02
    ...
    jenni "But aborting you...that's too much, even for me."
    ...
    if brianaevent02.status == "completed":
        ...
        menu:
            "No, I want to see Mom first.(+5 Mom love)":
                $ReinaC.love_up(5)
                jenni "Wait, [player_name]!!"
                jump consolereina
            "Will Mom be ok?(+ 2 Jenni trust)":
                scene 55briana02
                $JenniC.trust_up(2)
                jenni " She'll be fine. She just needs her alone time."
                menu:
                    "I want to go to visit her.(+ 2 Mom Love)":
                        $ReinaC.love_up(2)
                        jump consolereina
...
label consolereina:
    ...
    scene 66briana02
    reina "I never regretted having you, I want you to know that."
    reina "Even if you came earlier than expected, I always wanted to get married and have children."
    reina "I never thought about how your father felt about it."
    main "Now you know the truth. "
    scene 68briana02
    reina "Yeah, the truth."
...
label mckissingreinachoice:
    ...
    menu:
        "Kiss her.":
            ...
            "(I'll just leave.)"
            main "Aunt Jenni is going to drive me home. Good night, Mom."
            scene 79briana02 with fade
            jenni "There you are."
            ...
            jump jennidropsmcoff         
        "Pull away.":
            "(What am I thinking, it's my fucking mother.)"
