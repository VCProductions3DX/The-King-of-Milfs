label jennievent04:
    ...
    if jennicare in choices:
        ...
        main "I'm feeling better, I don't need your personal help Aunt Jenni."
    ...
    main "You have mom."
    scene 14jenni04
    jenni "Yes, but she has her own life."
    ...
    scene 28jenni04
    "(Wow Aunt Jenni's popular.)"
    scene 29jenni04
    if jennievent04.status == "completed":
        scene 30jenni04
        "(Woah.)"
        scene jenniselfie
        "(I thought Aunt Jenni was an actual model. Not this type of model.)"
    else:
        menu:
            "Click the gallery.":
                scene 30jenni04
    ...
    scene 35jenni04
    jenni "Ok, you got me."
    jenni "You won't tell your mother, will you?"
    scene 36jenni04
