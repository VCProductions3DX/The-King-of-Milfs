label epilogue02event:
    ...
    scene 42epilogue02
    "(Miyuki Hayashibara. So she's Dad's mistress.)"
    scene 43epilogue02
    jenni "There you are."
    main "Hi Aunt Jenni."
    scene 44epilogue02
    ...
    scene 47epilogue02
    main "I overheard a conversation between that chairwoman ..and Dad."
    main "I think they're in a relationship."
    scene 48epilogue02
    jenni "Her? Of all people?"
    scene 49epilogue02
    jenni "Do not tell anyone, especially not your mother."
    scene 50epilogue02
    $epilogue02.status_completed("not completed")
