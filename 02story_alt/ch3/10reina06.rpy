label reinaevent06:
    ...
    "(That was a long night. I can't believe I overslept again.)"
    "(But I made it in time.)"
    scene 03reina06
    reina "[player_name]."
    scene 02reina06
    main "Sorry I'm late, Mom."
    ...
    scene 09reina06
    reina "26 years. Since I was 18."
    maxine "How many children do you have together? Are there any under 18?"
    reina "I have 3 children over the age of 18."
    scene 10reina06
    ...
    if reinaevent07.status == "completed":
        ...
        menu:
            ...
            "Think about how miserable he makes everyone.":
                ...
                reina "For my family."
                jump reinapicksdivorce
            "He has a mistress.(Mom Trust + 3)" if miyukiethanphoto in choices:
                stop music
                scene 19reina06
                reina "What?"
    ...
    label maxinereturns:
        ...
        $reinaevent06.status_completed("not completed")
