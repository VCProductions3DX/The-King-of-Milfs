label miyukievent02:
    ...
    scene 05miyuki02
    $miyukievent02.status_completed("not completed")
    ...
    menu:
        ...
        "Ethan is my dad.":
            ...
            miyuki "Ethan has a son???"
            $choices.append(miyukiblackmail)
            miyuki "And it's you???"
            scene 08miyuki02
            miyuki "Wait-wait-wait-"
            miyuki "You do look a little bit like him."
            miyuki "Listen, you have to keep what we say and do here a secret."
            scene 09miyuki02
                ...
                "My silence isn't free.":
                    ...
                    menu:
                        "Stop the project.":
                            ...
                            scene 19miyuki02
                            miyuki "Did your mom put you up to this?"
                            main "That's not important."
                            scene 20miyuki02
                            miyuki "Yes, it is."
                            miyuki "You're a mommy's boy, aren't you?"
                            miyuki "You would do anything to make your mommy happy."
                            miyuki "Even hurting your dad."
                            scene 21miyuki02
                            ...
                            menu:
                                "Nothing, I'm leaving.":
                                    scene 22miyuki02
                                    miyuki "Goodbye."
                                    miyuki "No harsh feelings if I tell your dad about us."
                                    miyuki "I'm sure he'll straighten you out.."
                                    menu:
                                        "Walk away.":
                        ...
                        "A nice fuck.":
                            ...
                            miyuki "You must really hate your father."
                            miyuki "I hope you don't have an Oedipus complex."
                ...
                "You should have thought of that before talking to me.":
                    ...
                    menu:
                        "Not my problem.":
                            ...
                            jump freeroamch4
                        "Enough to let his son fuck you?":
                            scene 40miyuki02
...
label fuckmiyukisecondtime:
    ...
    "(Dad would hate me right now.)"
    "(But fuck him.)"
    scene miyukifuck03
    "(He mistreated Mom, so I'll fuck his girlfriend too.)"
