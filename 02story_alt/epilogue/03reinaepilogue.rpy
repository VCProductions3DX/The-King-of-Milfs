label reinaending:
    scene 01reinaending with fade
    reina "Thank you for coming with me tonight."
    reina "I always hate these award shows."
    reina "They're so boring."
    ...
    "(Mom looks so youthful and cheerful.)"
    ...
    scene 09reinaending
    "(After years of bullying, I finally won over Dad,)"
    scene 11reinaending
    "(I took everything from him, including Mom.)"
    scene 10reinaending
