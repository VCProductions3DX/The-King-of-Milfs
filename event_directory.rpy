...
default sabrinaevent04 = CharacterEvent("The Funeral", status="not completed", desc= "That player attends the funeral for Jane, Sabrina's cousin. "image=None)
...
default sabrinaevent05 = CharacterEvent("Sabrina's Future", status="not completed",desc="Sabrina decides what to do with her future." image="images/titles/sabrina05title.webp")
